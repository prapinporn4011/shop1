...
<head>
    ...
    <style>
      ...
      /* แบนเนอร์ CR7 หน้าร้าน */
        .hero-banner { 
            background: linear-gradient(to right, rgba(10, 10, 10, 0.9), rgba(10, 10, 10, 0.2)), url('https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Cristiano_Ronaldo_2018.jpg/1200px-Cristiano_Ronaldo_2018.jpg');
        ...
        container.innerHTML = items.map(p => {
            ...
            <div class="col-6 col-md-3 mb-4">
                <div class="card product-card sport-font">
                    ${saleBadge}
                    <img src="${p.img}" onerror="this.src='https://dummyimage.com/250?text=No+Image'" class="card-img-top" alt="${p.name}">
